...
version()
{
  return std::make_pair<std::string, std::string>(CHANNELER_PACKAGE_MAJOR,
      CHANNELER_PACKAGE_MINOR);
}
...
{
  return
    CHANNELER_PACKAGE_NAME " " CHANNELER_PACKAGE_VERSION " "
      CHANNELER_PACKAGE_URL "\n"
